package co.edu.unincca.is.test.testing6;
...
public class Testing_ValueConclusionLine_6 {
	...
	public static void main(String[] args) throws IOException {
		...
		ilr.setStreamSource(Testing_ValueConclusionLine_6.class.getResourceAsStream("Testing ValueConclusionLine with NOT, KNOW, IS, and IS IN LIST features.txt"));
