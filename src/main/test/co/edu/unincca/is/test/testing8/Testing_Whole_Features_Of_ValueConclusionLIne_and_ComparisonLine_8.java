package co.edu.unincca.is.test.testing8;
...
public class Testing_Whole_Features_Of_ValueConclusionLIne_and_ComparisonLine_8 {
	...
	public static void main(String[] args) throws IOException {
		...
		IntStream.range(0, nodeListMock.size()).forEach(i->{
			...
			if(actualNode.getNodeName().equals("person's nationality IS â€œAustralianâ€�")
			...
			else if(actualNode.getNodeName().equals("person passport type = â€œAustralianâ€�")
					&&mockNode.equals(actualNode.getNodeName())
			...
			else if(actualNode.getNodeName().equals("person passport issued country = â€œAustralianâ€�")
					&&mockNode.equals(actualNode.getNodeName())
			...
			else if(actualNode.getNodeName().equals("person's citizenship status = â€œcanceledâ€�")
					&&mockNode.equals(actualNode.getNodeName())
			...
			else if(actualNode.getNodeName().equals("person's permanent residentship status = â€œcanceledâ€�")
					&&mockNode.equals(actualNode.getNodeName())
